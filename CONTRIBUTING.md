...
Os bugs são rastreados como [issues](https://github.com/Kotlin-BR/kotlin-no-backend/issues) no GitHub, crie um problema
...
As sugestões de melhorias são rastreadas como [issues](https://github.com/Kotlin-BR/kotlin-no-backend/issues) no
...
- Abra um [pull request](https://github.com/Kotlin-BR/kotlin-no-backend/pulls).
